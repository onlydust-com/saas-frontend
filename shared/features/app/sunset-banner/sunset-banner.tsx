...
export function SunsetBanner() {
  const handleRedirect = () => {
    window.location.href = "https://contribute.onlydust.com";
  };
        ...
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm font-medium">
              <div>We're transitioning to a new platform that opens opportunities beyond blockchain projects to include all open source projects.</div>
