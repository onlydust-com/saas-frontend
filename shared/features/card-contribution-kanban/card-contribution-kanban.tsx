...
export function CardContributionKanban({ contribution }: CardContributionKanbanProps) {
  const actionGroup = CardContributionKanbanHooks.useContributionActions(contribution);
  return (
