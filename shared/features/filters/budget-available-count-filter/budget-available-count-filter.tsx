...
export function BudgetAvailableCountFilter({ value, onChange, currency }: BudgetAvailableCountFilterProps) {
  return (
    <AccordionFilter
    ...
    >
      <QuantityFilter name={"budget-available-count"} value={value} onChange={onChange} currency={currency} />
    </AccordionFilter>
  );
}
