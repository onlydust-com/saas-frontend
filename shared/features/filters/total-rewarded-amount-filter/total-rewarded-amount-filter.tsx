...
export function TotalRewardedAmountFilter({ onChange, value, unit }: TotalRewardedAmountFilterProps) {
  return (
    <AccordionFilter
    ...
    >
      <QuantityFilter name={"total-rewarded-amount"} value={value} onChange={onChange} unit={unit} />
    </AccordionFilter>
  );
}
