...
export function ExportCsvSidepanel({
  filters: { types, dateRange, onDateRange, clear },
  exportedData,
  onExport,
  ...
  return (
    <Panel>
      <SidePanelHeader
        title={{ translate: { token: "panels:transactions.export.title" } }}
        canGoBack
        canClose
        onClose={clear}
      />
      ...
      <SidePanelBody>
        <Paper size="lg" background="primary" border="primary" classNames={{ base: "flex flex-col gap-lg" }}>
          <Typo size="sm" weight="medium" translate={{ token: "panels:transactions.filters.options.types.title" }} />
        ...
        <Paper size="lg" background="primary" border="primary" classNames={{ base: "flex flex-col gap-lg" }}>
          <Typo size="sm" weight="medium" translate={{ token: "panels:transactions.filters.options.period.title" }} />

          <DateRangePicker value={dateRange} onChange={onDateRange} />
        </Paper>

        <Paper size="lg" background="primary" border="primary" classNames={{ base: "flex flex-col gap-lg" }}>
          <Typo size="sm" weight="medium" translate={{ token: "panels:transactions.export.data.title" }} />
      ...
      <SidePanelFooter>
        <Button
          ...
          size="md"
          translate={{
            token: "panels:transactions.export.button",
          }}
          onClick={onExport}
        />
      </SidePanelFooter>
