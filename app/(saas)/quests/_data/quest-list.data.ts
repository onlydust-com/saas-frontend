...
export const QuestListData: QuestList[] = [
  ...
  },
  {
    ...
    status: "started",
    issues: [
      2995747338, 2995757762, 2995765815, 2995768988, 2995771796, 2995818273, 3000931476, 3000939939, 3000947203,
      3000948779, 3000949741, 3000950840, 3000958183, 3000959681, 3000963715, 3000964805, 3000985652, 3000988936,
      3000991909, 3000994266, 3000998783, 3001003288, 3001004336, 3001005533, 3006110813,
    ],
    maintainers: [51526246],
  },
  {
