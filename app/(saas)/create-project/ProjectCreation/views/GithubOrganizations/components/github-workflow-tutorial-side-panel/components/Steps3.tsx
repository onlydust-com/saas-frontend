  ...
  return (
    <Card className="flex w-full flex-col items-start justify-start gap-6 p-5">
      <div className="flex w-full flex-col items-start justify-start gap-2">
        <TypographyP className="uppercase">3. Grant permissions to OnlyDust</TypographyP>
        <TypographyMuted>And you&apos;re good to go, you can now install the OnlyDust Github app.</TypographyMuted>
      </div>
      <img
