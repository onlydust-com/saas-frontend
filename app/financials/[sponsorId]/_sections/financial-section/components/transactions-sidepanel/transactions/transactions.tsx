    ...
    <>
      ...
      {!items.length ? (
        <div className="flex flex-col items-center gap-1 py-4">
          <Typo variant="heading" translate={{ token: "financials:transactionPanel.transactions.empty.title" }} />
          <Typo size="sm" translate={{ token: "financials:transactionPanel.transactions.empty.description" }} />
        </div>
      ) : (
        <Accordion
