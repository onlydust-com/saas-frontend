    ...
    <div className={"flex flex-col gap-6"}>
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 laptop:grid-cols-2">
          ...
          <form className="p-6 laptop:p-8">
            <div className="flex flex-col gap-6">
              <div className="border-bottom-1 flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold">Welcome to OnlyDust</h1>
              </div>
