import { projectsCategoriesApiClient } from "@/legacy/api-client/resources/project-categories";
import { TSelectAutocomplete } from "@/legacy/components/ds/form/select-autocomplete/select-autocomplete.types";
import { NEXT_ROUTER } from "@/legacy/constants/router";
import EcosystemApi from "@/legacy/src/api/Ecosystems";
import ProjectApi from "@/legacy/src/api/Project";
import MeApi from "@/legacy/src/api/me";
import { UseGithubOrganizationsResponse } from "@/legacy/src/api/me/queries";
import useMutationAlert from "@/legacy/src/api/useMutationAlert";
import Background, { BackgroundRoundedBorders } from "@/legacy/src/components/Background";
import { AutoSaveForm } from "@/legacy/src/hooks/useAutoSave/AutoSaveForm";
import { usePooling, usePoolingFeedback } from "@/legacy/src/hooks/usePooling/usePooling";
import { StorageInterface } from "@/legacy/src/hooks/useStorage/Storage";
