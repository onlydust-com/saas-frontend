...
export const marketplaceApiBasePaths = {
  ...
  [MarketplaceApiVersion.v3]: (path: string) => `${MARKETPLACE_API_BASE_URL}/api/${MarketplaceApiVersion.v3}/${path}`,
};
...
export const marketplaceApiMockBasePaths = {
  ...
  [MarketplaceApiVersion.v3]: (path: string) => `${MARKETPLACE_API_MOCK_URL}/api/${MarketplaceApiVersion.v3}/${path}`,
};
