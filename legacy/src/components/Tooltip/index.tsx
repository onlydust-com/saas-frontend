...
export default function Tooltip({
  ...
  return createPortal(
    <ReactTooltip
      ...
      delayShow={delayShow}
      className={cn(
        "!text-greyscale-50 !rounded-lg !text-sm", // !important class is required to override some react-tooltip classes
        "opaque font-walsheim text-center font-normal shadow-md",
        variants[variant],
