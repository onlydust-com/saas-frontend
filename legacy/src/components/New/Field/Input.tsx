...
export const FieldInput = forwardRef(function FieldInput(
  ...
  return (
    <Field {...rest}>
      <div
        className={cn(
          "border-greyscale-50/8 font-walsheim focus-within:border-spacePurple-500 focus-within:bg-spacePurple-900 focus-within:ring-spacePurple-500 relative flex w-full items-center gap-2 rounded-lg border bg-white/5 text-sm leading-none focus-within:ring-1",
      ...
      >
        ...
        <input
          ...
          onFocus={onFocus}
          className={cn(
            "text-greyscale-50 placeholder:text-spaceBlue-200 h-full w-full bg-transparent px-3 py-2 outline-none",
            inputClassName,
            startIcon && "pl-8",
            endIcon && "pr-8"
          )}
