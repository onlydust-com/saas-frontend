...
export const ModalNextUiVariants = tv({
  ...
  variants: {
    ...
    background: {
      ...
      gradient: {
        modal: cn(
          "before:effect-bg-blur-shadow before:gradient-glass-neon-45 bg-transparent backdrop-blur-md backdrop-filter before:pointer-events-none before:absolute before:inset-0 before:-z-[1]"
        ),
      },
    },
  },
