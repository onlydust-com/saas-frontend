...
export const PaperDefaultVariants = tv({
  ...
  variants: {
    ...
    border: {
      ...
      primary: { base: "border border-primary" },
      "primary-hover": { base: "border-primary-hover border" },
      "primary-alt": { base: "border-primary-alt border" },
      secondary: { base: "border border-secondary" },
      tertiary: { base: "border-tertiary border" },
      disabled: { base: "border-disabled border" },
      "brand-primary": { base: "border-brand-primary border" },
      "brand-secondary": { base: "border-brand-secondary border" },
      "error-primary": { base: "border-error-primary border" },
      "error-secondary": { base: "border-error-secondary border" },
      "error-secondary-hover": { base: "border-error-secondary-hover border" },
      "warning-primary": { base: "border-warning-primary border" },
      "warning-secondary": { base: "border-warning-secondary border" },
      "success-primary": { base: "border-success-primary border" },
      active: { base: "border-active border" },
      "success-secondary": { base: "border-success-secondary border" },
    },
    clickable: {
